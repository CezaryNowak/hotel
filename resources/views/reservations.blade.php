                                        ...
                                        <div class="flex justify-between items-center">
                                            <div>
                                                <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200">
                                                    {{ __('Reservation for Room Number: ') }} {{ $reservation['room'] }}
                                                </h2>
                                            ...
                                            <div>
                                                ...
                                                <x-danger-button x-data=""
                                                    x-on:click.prevent="$dispatch('open-modal', 'confirm-reservation-cancelation')">
                                                    {{ __('Cancel') }}
                                                </x-danger-button>

                                                <x-modal name="confirm-reservation-cancelation" focusable>
                                                    <form method="POST"
